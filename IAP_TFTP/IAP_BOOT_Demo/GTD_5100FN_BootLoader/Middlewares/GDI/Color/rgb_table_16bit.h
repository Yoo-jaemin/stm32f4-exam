#ifndef   __RGB_TABLE_16BIT_H__
#define   __RGB_TABLE_16BIT_H__


// 16bit Color Table
#define RGB.RED		        		( 0xF800 )
...
//#define RGB.GREEN		    		( 0x0400 )
#define RGB.GREEN		    		( 0x07E0 )
...
#define RGB.LIGHTSKYBLUE			( 0x867F )
...
#define RGB.WHITE		    		( 0xFFFF )
#define RGB_GAINSBORO				( 0xDEFB )
#define RGB_LIGHTGRAY				( 0xD69A )
